...
export const HimtiTabs = ({ tabs, activeTab, setActiveTab, containerClassName, activeTabClassName, tabClassName }) => {
  return (
    <>
      {/* Tampilan Desktop*/}
      <div
        ...
        <div className="flex items-center justify-start overflow-x-auto pb-2 no-scrollbar">
            ...
            <button
                ...
                className={cn(
                    ...
                    tabClassName,
                    activeTab.value === tab.value ? "text-blue-600 font-bold" : "text-gray-500"
                )}
            >
                {activeTab.value === tab.value && (
                <motion.div
