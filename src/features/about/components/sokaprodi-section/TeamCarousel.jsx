            ...
            >
              <div className="relative">
                <img
                  ...
                  alt={member.name}
                  className={cn(
                    "w-full h-95 object-cover transition-all duration-500 ease-in-out",
              ...
              <div className="p-6 text-center">
                ...
                <Poppins className="text-yellow-500 font-semibold mt-1">{member.role}</Poppins>
                <Poppins className="text-gray-500 text-sm mt-2">{member.bio}</Poppins>
              </div>
            </motion.div>
          </div>
        ))}
